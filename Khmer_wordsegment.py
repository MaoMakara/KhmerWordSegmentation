...
class AngkorSegmentation:
    ...
    def show(self):
        ...
        filtered_result_all = [word for word in self.result_all if word.strip()]
        print("\033[1msegmentation:\033[0m ", filtered_result_all)
        print('\033[1mZeroSpace : \033[0m [' + '​'.join(filtered_result_all) + ']')
        ...
        words_not_in_csv = [word for word in filtered_result_all if word not in existing_words]
        if words_not_in_csv:
